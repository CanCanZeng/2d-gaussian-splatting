...
class GaussianModel:
    ...
    def restore(self, model_args, training_args):
        ...
        self.max_radii2D, 
        xyz_gradient_accum, 
        xyz_gradient_abs_accum,
        denom,
        opt_dict, 
        self.spatial_lr_scale) = model_args
        self.training_setup(training_args)
        self.xyz_gradient_accum = xyz_gradient_accum
        self.xyz_gradient_abs_accum = xyz_gradient_abs_accum
        self.denom = denom
    ...
    def prune_points(self, mask):
        ...
        self.xyz_gradient_abs_accum = self.xyz_gradient_abs_accum[valid_points_mask]
    ...
    def densify_and_prune(self, max_grad, max_abs_grad, min_opacity, extent, max_screen_size):
        grads = self.xyz_gradient_accum / self.denom
        grads[grads.isnan()] = 0.0

        abs_grads = self.xyz_gradient_abs_accum / self.denom
    ...
    def add_densification_stats(self, viewspace_point_tensor, update_filter):
        self.xyz_gradient_accum[update_filter] += torch.norm(viewspace_point_tensor.grad[update_filter, 0:2], dim=-1, keepdim=True)
        self.xyz_gradient_abs_accum[update_filter] += torch.norm(viewspace_point_tensor.grad[update_filter, 2:4], dim=-1, keepdim=True)
